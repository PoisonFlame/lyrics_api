...
var virtual_TextMiningApplier20 = {
  name: 'TextMiningApplier20',
  functional: true,
  ...
  render: function render(createElement, context) {
    ...
    return createElement('svg', svgData, [props.title && createElement('title', null, props.title), createElement('polygon', {
      attrs: {
        "points": "16.001 26.473 16 26.473 4.284 12.955 9.5 6 22.5 6 27.716 12.955 24.476 16.692 25.989 18.002 30.284 13.045 23.5 4 8.5 4 1.716 13.045 14.488 27.782 16.001 26.473"
      }
    }), createElement('polygon', {
      attrs: {
        "points": "20 19 27 24 20 29 20 19"
      }
    }), children]);
  }
};

export default virtual_TextMiningApplier20;
